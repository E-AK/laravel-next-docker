 ...
 */
final class Version20250313132049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notification (id SERIAL NOT NULL, task_id UUID NOT NULL, datetime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, email VARCHAR(1023) NOT NULL, sent BOOLEAN NOT NULL, PRIMARY KEY(id))');
